...
const Create = () => {
  ...
  const initializeContract = async () => {
    try {
      ...
      return new Contract(tokenLaunchpadAddress, abi, signer);
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-slate-800/50 rounded-xl shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              focus:border-[#845DDE] focus:ring-2 focus:ring-[#845DDE]/20 focus:outline-none
            ...
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-700 border-dashed rounded-lg">
              <div className="space-y-1 text-center">
                ...
                <div className="flex text-sm text-slate-400">
                  <label
                    htmlFor="image"
                    className="relative cursor-pointer rounded-md font-medium text-[#845DDE] hover:text-blue-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[#845DDE]"
                  >
        ...
        <div className="pt-4">
          <button
            className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-[#845DDE] to-blue-600 
            hover:from-blue-600 hover:to-blue-700 text-white font-medium
            transform transition-all duration-200 ease-in-out
            hover:scale-[1.02] active:scale-[0.98] 
            shadow-lg hover:shadow-xl
            focus:outline-none focus:ring-2 focus:ring-[#845DDE] focus:ring-opacity-50
                ...
                <button
                  onClick={() => {
                    const explorerBaseUrl =
                      ...
                      "https://testnet.blockscout.com";
                    window.open(
                      `${explorerBaseUrl}/token/${successModal.tokenAddress}`,
                      "_blank",
                      "noopener,noreferrer"
                    );
                  }}
                  className="flex-1 px-4 py-2 bg-[#845DDE] hover:bg-blue-600 text-white rounded-lg 
